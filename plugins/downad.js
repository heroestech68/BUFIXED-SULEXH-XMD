    ...
    const messagePayloads = [
      {
        ...
        mimetype: 'audio/mp4',
        caption: `🎵 *${safeTitle}*\n✨ Powered by ${BOT_NAME}`,
        contextInfo: getContextInfo(safeTitle, userJid, video.thumbnail)
      },
      {
        document: { url: download_url },
        mimetype: 'audio/mpeg',
        fileName: `${safeTitle}.mp3`,
        caption: `📁 *${safeTitle}* (Document)\n✨ Powered by ${BOT_NAME}`,
        contextInfo: getContextInfo(safeTitle, userJid, video.thumbnail)
      }
    ];
...
ezra({
  ...
  try {
    if (!msgRepondu) return repondre(zk, dest, ms, "Please mention an image, video, or audio.");
